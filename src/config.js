...
(function (RallyOne) {
  ...
  const SPECIAL = {
    ...
    DUNK: {
      MIN_Y: 1.45,           // この高さ以上の打点なら発動できる（通常の PLAYER.SMASH_MIN_Y より低い）
      REACH_Y_BONUS: 0.45,   // 打てる高さの上限（PLAYER.REACH_Y）をこれだけ引き上げる
      T_MULT: 0.78,          // SHOT.SMASH_T に掛ける（＝通常のスマッシュよりさらに速い）
      ...
      // ここで頭打ちにする。62m/s ≒ 223km/h（ダンクスマッシュの上限として十分速い）。
      MAX_SPEED: 62,
