...
(function (RallyOne) {
  ...
  const CPU = {
     ...
     * （SHOT_T=0.92 の中速・深さ 6.8〜9.4m）で、ネット際でノーバウンドに捕まえた球まで
    ...
    VOLLEY_ANGLE_X: 3.4,  // 決め球：サイドライン際（HALF_W=4.115）へ切る
    VOLLEY_BLOCK_Z: 6.0,  // ブロック：無難な深さ
    VOLLEY_ANGLE_Z: 2.8,  // 決め球：ネット際へ短く落とす角度
    VOLLEY_BLOCK_T: 0.62, // ブロックはゆるい
    VOLLEY_ANGLE_T: 0.34, // 決め球は低く鋭い（SHOT_T=0.92 の3倍近い初速）
    ...
    SMASH_T: 0.34,           // 飛翔時間。SHOT_T(0.92)よりはるかに短い＝速く突き刺さる
